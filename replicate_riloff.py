...
def bootstrap(seedword,tweets):
    ...
    while True:
        ...
        old_neg = neg_phrases
        new_neg = []
        for np in pos_verbs - old_pos:
            new_neg.extend(learn_new_phrases(np,'neg',tweets))
        ...
        old_pos = pos_verbs
        new_pos = []
        for np in neg_phrases - old_neg:
            new_pos.extend(learn_new_phrases(np,'pos',tweets))
    ...
    return {'pos':pos_phrases, 'neg':neg_phrases, 'pospred': None}
...
if __name__ == '__main__':
    ...
    print("pos")
    print(ground_pos_expr & riloff_discards['pos'])
    print("neg")
    print(ground_neg_expr & riloff_discards['neg'])
    #print("pospred")
    #print(ground_predicate_expr & riloff_discards['pos'])
    print()
